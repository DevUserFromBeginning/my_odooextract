...
def main():
    ...
    ordersLines = models.execute_kw(db, uid, password,'res.users', 'search_read',
                                 [[]],
                                 {'fields':[]})
    ...
    wb.save(r"C:\\Users\\ESCH\Desktop\\odoo_api\\excel\\res.users.xlsx")        
