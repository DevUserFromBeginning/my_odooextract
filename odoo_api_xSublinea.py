...
.- Extraer los registros del modelo: x_subninea
...
def main():
    ...
    ordersLines = models.execute_kw(db, uid, password,'x_subninea', 'search_read',
                                 [[]],
                                 {'fields':['id','display_name','x_studio_descripcin','x_active','x_name','create_date','__last_update']})
    ...
    wb.save(r"C:\\Users\\ESCH\Desktop\\odoo\\excel\\x_sublinea.xlsx")        
