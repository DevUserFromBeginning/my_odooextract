...
.- Extraer los registros del modelo: x_linea
...
def main():
    ...
    ordersLines = models.execute_kw(db, uid, password,'x_linea', 'search_read',
                                 [[]],
                                 {'fields':['id','display_name','x_studio_descripcin','x_name','create_date','__last_update']})
    ...
    wb.save(r"C:\\Users\\ESCH\Desktop\\odoo\\excel\\x_linea.xlsx")        
